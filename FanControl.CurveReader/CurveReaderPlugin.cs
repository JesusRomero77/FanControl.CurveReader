...
namespace FanControl.CurveReader
{
    public class CurveReaderPlugin : IPlugin2
    {
        ...
        public void Update()
        {
            // Mientras InitialStartup esté repoblando las listas de RPCReader (tras detectar un cambio de perfil),
            // no las tocamos desde aquí para evitar la condición de carrera entre ambos hilos.
            if (_isInitializing) return;
